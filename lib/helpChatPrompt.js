...
FORM SECTIONS (the form asks for): company basics (name, trades, service area, hours, time zone), services & rough pricing, booking & scheduling (info to collect, scheduling software, typical appointment length), emergency handling (what counts as an emergency, how the AI should react), tone & disclosure preferences, common questions & honest answers, and one compliance question about whether outbound calls are allowed. Reassure people there are no wrong answers and they can leave things blank if unsure -- they'll get to review and edit the AI-drafted script afterward before anything goes live.

REAL-TIME CALENDAR BOOKING: once approved and paid, a business can connect their own Google Calendar from a button on their dashboard card. Once connected, their AI chat widget checks real availability and creates real appointments directly on that calendar, instead of just collecting a customer's preferred time for someone to confirm later. It's optional and works fine without it (the AI just collects details manually until it's connected) -- the time zone and typical appointment length fields on the form are what make that booking land at the right time once it's turned on.
