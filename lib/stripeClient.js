...
async function createCheckoutSession({ clientId, priceId, companyName, successUrl, cancelUrl }) {
...
module.exports = { createCheckoutSession, verifyStripeSignature, createPortalSession, getCheckoutSession };
